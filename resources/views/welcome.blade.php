  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      @if (Route::has('login'))
            ...
            @auth
                <a href="{{ url('/admin/dashboard') }}" class="btn btn-getstarted">Dashboard</a>
            @else
                <a href="{{ route('login') }}" class="btn btn-getstarted">Login</a>
                
                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="btn btn-getstarted">Register</a>
                @endif
            @endauth
